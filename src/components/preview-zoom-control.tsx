...
export const PreviewZoomControl = React.memo(
  ({ value, onValueChange }: PreviewZoomControlProps) => {
    return (
      <div className="bg-muted/50 dark:bg-muted/50 rounded-md transition-opacity border-1 border-muted shadow-sm backdrop-blur-xs absolute bottom-8 left-1/2 -translate-x-1/2 md:left-4 md:translate-x-0 z-30 flex-shrink-0 p-2">
